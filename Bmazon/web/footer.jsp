                ...
                <div class="section-content relative">
                    ...
                    <div class="row row-collapse"  id="row-890024058">
                        ...
                        <div class="col medium-3 small-12 large-3"  ><div class="col-inner" style="padding:0px 10px 0px 0px;" >
                                ...
                                <h3><a href="#">LIÊN HỆ VỚI LAZADA</a></h3>
                                <ul>
                                    <li><a>Thứ 2 - CN: 7h - 21h</a></li>
                                    <li><a>Trung tâm DVKH: Tầng 19, Tòa nhà Saigon Centre – Tháp 2, 67 Lê Lợi, Phường Bến Nghé, Quận 1, TP. Hồ Chí Minh</a></li>
                                    <li><a href="#">Thứ 2 - thứ 7: 9h - 18h</a></li>
                                    ...
                                    <li><a href="#">Hướng dẫn và điều kiện sử dụng voucher</a></li>
                                </ul>
                        ...
                        <div class="col medium-3 small-12 large-3"  ><div class="col-inner" style="padding:0px 10px 0px 0px;" >
                                ...
                                <ul>
                                    ...
                                    <li><a href="#" target="_blank" rel="noopener">Tuyển dụng</a></li>
                                    <li><a href="#">Điều khoản mua bán hàng hóa</a></li>
                                    <li><a href="#">Chính sách bảo mật</a></li>
                                    <li><a href="#">Báo chí</a></li>
                                    <li><a href="#">Thương hiệu tại Lazada</a></li>
                                    <li><a href="#">Danh mục sản phẩm</a></li>
                                    <li>Hộp thư nhận góp ý và phản hồi trực tiếp đến Tổng giám đốc mona.media : <a href="/cdn-cgi/l/email-protection#3e5351507e5351505f10535b5a575f"><span class="__cf_email__" data-cfemail="335e5c5d735e5c5d521d5e56575a52">[email&#160;protected]</span></a></li>
                                    <li><a href="#">Quy chế quản lý hoạt động</a></li>
                                    <li><a href="#" target="_blank" rel="noopener">Redmart</a></li>
                                </ul>
