                    ...
                    <div class="customers">
                        <div class="card">
                            <div class="card-header">
                                <h3>User</h3>
                                <a href="AdminControllerMap?service=adduser">
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="AdminControllerMap?service=updateuser&userid=<%=user.getUserId()%>"><span class="las la-edit"></span></a></td>
                                            <td><a href="AdminControllerMap?service=deleteuser&userid=<%=user.getUserId()%>"><span class="las la-trash"></span></a></td>
                                        </tr>
                                        <%}%>
                                    </tbody>
                                </table>
