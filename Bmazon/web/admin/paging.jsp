...
<%
    ...
    ArrayList<User> listPaging = (ArrayList<User>) request.getAttribute("listPaging");
%>
                                        ...
                                        <div class="table_head py-3" style="display: flex;
                                            ...
                                            <div class="rowNum">
                                                ...
                                                <div class="form-group" style="display: inline;">
                                                    <select onchange="myFunction()" name="state" id="maxRows" class="form-control" style="width:80px;display:inline;">
                                            ...
                                            <div class="tb_search">
                                                <input id="search" style="width: 100%;" type="text" oninput="myFunction()" placeholder="Search.." class="form-control">
                                            </div>
                                        </div>
                                    ...
                                    <div class="pagination-container mt-4" style="display: flex;
                                        ...
                                        <nav>
                                            <ul class="pagination">
                                                ...
                                                <%if (index == i) {%>
                                                <li onclick="myFunction()" class="page-item active" data-repair="<%=i%>">
                                                <%} else {%><li onclick="myFunction()" class="page-item" data-repair="<%=i%>"> <%}%>
                                                    <a class="page-link">
