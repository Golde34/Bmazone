        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="AdminControllerMap?service=usermanagement">
                    ...
                    <div class="customers">
                        <div class="card">
                            <div class="card-header">
                                <h3>Some Customer</h3>
                                <a href="AdminControllerMap?service=usermanagement">
                                    <button>See all<span class="las la-arrow-right"></span></button></a>
                            </div>
                            <div class="card-body">
                                <%for (User user : listUser) {%>
                                <div class="customer">
                                    <div class="info">
                                        <img src="images/defaultPicture.jpg" width="40px" height="40px">
