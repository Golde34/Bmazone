        ...
        <div class="container">
            <div id="logreg-forms">
                <form class="form-signin" action="/Bmazon/LoginControllerMap" method="POST">
                    <p style="font-size: 30px;"> Verify account</p>
                    <br>

                    <!--verify code-->
                    <h4 style="color: ">A verify code has been sent to your email, check it!</h4>
                    <label for="phone" class="label">Code</label>
                    <input id="phone" type="text" pattern="([0-9]{6})\b" name="veriCode" value="${veriCode}" class="form-control" placeholder="Verification code" required autofocus="" >

                    <br>

                    <p class="text-right" style="font-size: 12px;"><%= mess.toString()%></p>
                    <input type="hidden" name="service" value="verify">
                    <button class="btn btn-secondary btn-block buttonSignIn" type="submit"><i
                            class="fas fa-sign-in-alt"></i> Verify my account</button>
                    <br>
                    <p style="font-size: 15px;">Forget something?</p>
                    <div class="row">
                        <a class="col-md-6" style="font-size: 15px;" href="${contextPath}/loginAndSecurity/register.jsp" id="cancel_signup" > Back to Register</a>
