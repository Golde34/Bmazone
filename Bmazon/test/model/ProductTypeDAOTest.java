...
public class ProductTypeDAOTest {
    ...
    public void testDeleteProductTypeNotExist() {
        System.out.println("deleteProductType");
        ProductTypeDAO instance = new ProductTypeDAO();
        assertEquals(0, instance.deleteProductType("Pr110Ty1"));
    }
    /**
    ...
    public void testGetProductTypeByPTypeIDWrong() {
        ...
        ProductTypeDAO instance = new ProductTypeDAO();
        ProductType result = instance.getProductTypeByPTypeID("Pr15Ty1");
        assertNotEquals(16, result.getProductID());
    }
    @Test
    public void testGetProductTypeByPTypeIDNotExist() {
        System.out.println("getProductTypeByPTypeID");
        ProductTypeDAO instance = new ProductTypeDAO();
        ProductType result = instance.getProductTypeByPTypeID("Pr150Ty1");
    ...
    public void testGetProductIdByProductTypeIdWrong() {
        ...
        @Test
    public void testGetProductIdByProductTypeIdNotExist() {
        System.out.println("getProductIdByProductTypeId");
        ProductTypeDAO instance = new ProductTypeDAO();
        int result = instance.getProductIdByProductTypeId("Pr150Ty1");
    ...
    public void testGetProductByProductIDWrong() {
        ...
        @Test
    public void testGetProductByProductIDNotExist() {
        System.out.println("getProductByProductID");
        ProductTypeDAO instance = new ProductTypeDAO();
        List<ProductType> result = instance.getProductByProductID(150);
    ...
    public void testGetProductTypeByColorAndSizeWrong() {
        ...
        @Test
    public void testGetProductTypeByColorAndSizeNotExist() {
        System.out.println("getProductTypeByColorAndSize");
        ProductTypeDAO instance = new ProductTypeDAO();
        ProductType result = instance.getProductTypeByColorAndSize("Phantom Bronze", "256GB", "150");
        assertEquals(null, result.getProductTypeId());
    }
    /**
    ...
    public void testGetProductByColorWrong() {
        ...
        @Test
    public void testGetProductByColorNotExist() {
        System.out.println("getProductByColor");
        ProductTypeDAO instance = new ProductTypeDAO();
        ArrayList<ProductType> result = instance.getProductByColor("Phantom Pink");
        assertEquals(0, result.size());
    }
    /**
    ...
    public void testGetAllSizeOfProductWrong() {
        ...
        @Test
    public void testGetAllSizeOfProductNotExist() {
        System.out.println("getAllSizeOfProduct");
        ProductTypeDAO instance = new ProductTypeDAO();
        ArrayList<String> result = instance.getAllSizeOfProduct(150);
        assertEquals(0, result.size());
    }
    /**
    ...
    public void testGetAllColorOfProductWrong() {
        ...
        @Test
    public void testGetAllColorOfProductNotExist() {
        System.out.println("getAllColorOfProduct");
        ProductTypeDAO instance = new ProductTypeDAO();
        ArrayList<String> result = instance.getAllColorOfProduct(150);
        assertEquals(0, result.size());
    }
    /**
    ...
    public void testChangeStatusOn() {
        ...
        @Test
    public void testChangeStatusProductNotExist() {
        System.out.println("changeStatus");
        ProductTypeDAO instance = new ProductTypeDAO();
        int result = instance.changeStatus("Pr150Ty1", 1);
        assertEquals(0, result);
    }
    /**
